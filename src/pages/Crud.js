...
const Crud = () => {
    ...
    const deleteSelectedProducts = () => {
        const productService = new ProductService();
        console.log("ok");
        productService.deleteProduct(selectedProducts[0].id);
    ...
    const myUploader = (file) => {
        ...
        const productService = new ProductService();
        console.log("ok");
        productService.uploadImageProduct(file.files[0]).then((data) => setUri(data));
        console.log(uri);
    };
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <Dialog visible={productDialog} style={{ width: "450px" }} header="Product Details" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        ...
                        <Toolbar className="mb-4" right={<FileUpload chooseOptions={chooseOptions} customUpload uploadHandler={myUploader} />}></Toolbar>
                        <div className="field">
                            <label className="mb-3">Category</label>
                            <div className="formgrid grid">
                                <div className="field-radiobutton col-6">
                                    <RadioButton inputId="category1" name="fastfood" value="drink" onChange={onCategoryChange} checked={product.category === "Accessories"} />
                                    <label htmlFor="category1">Fast Food</label>
                                </div>
                                <div className="field-radiobutton col-6">
                                    <RadioButton inputId="category2" name="fastfood" value="drink" onChange={onCategoryChange} checked={product.category === "Clothing"} />
                                    <label htmlFor="category2">Drink</label>
                                </div>
                            </div>
                        </div>
